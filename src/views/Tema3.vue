    ...
    .row.justify-content-center
      .col-lg-9.mb-5
        .row.align-items-center
          .col-2
            img(src='@/assets/curso/img27.png', style="max-width: 100%; position: relative; left: 50%;")
          .col-9.bg-color3.shadow
            .h4 Objetivo de comunicación interna
            p Este objetivo se centra en lo que se quiere lograr; por ejemplo, mantener informado al total de los empleados de la empresa acerca de las funciones que deben realizar en su puesto de trabajo.
      .col-lg-9.mb-5
        .row.align-items-center
          .col-2
            img(src='@/assets/curso/img28.png', style="max-width: 100%; position: relative; left: 50%;")
          .col-9.bg-color3.shadow
            .h4 Estrategias
            p En este punto se deben definir claramente las acciones a realizar para lograr los objetivos planteados: implementación de canales, tipo de comunicación.
      .col-lg-9.mb-5
        .row.align-items-center
          .col-2
            img(src='@/assets/curso/img29.png', style="max-width: 100%; position: relative; left: 50%;")
          .col-9.bg-color3.shadow
            .h4 Público objetivo
            p Aquí es importante realizar una segmentación y caracterización de los diferentes públicos a los que va dirigida la comunicación.
      .col-lg-9.mb-5
        .row.align-items-center
          .col-2
            img(src='@/assets/curso/img30.png', style="max-width: 100%; position: relative; left: 50%;")
          .col-9.bg-color3.shadow
            .h4 Áreas
            p Debe tenerse claro qué secciones de la empresa o departamentos van a ser objeto de la comunicación.
      .col-lg-9.mb-5
        .row.align-items-center
          .col-2
            img(src='@/assets/curso/img31.png', style="max-width: 100%; position: relative; left: 50%;")
          .col-9.bg-color3.shadow
            .h4 Mensajes claves
            p Información que se va generar y puntos clave en los que se va a centrar.
      .col-lg-9.mb-5
        .row.align-items-center
          .col-2
            img(src='@/assets/curso/img32.png', style="max-width: 100%; position: relative; left: 50%;")
          .col-9.bg-color3.shadow
            .h4 Ecosistema de medios
            p Selección de los medios a implementar para hacer llegar la información a los diferentes públicos.
      .col-lg-9.mb-5
        .row.align-items-center
          .col-2
            img(src='@/assets/curso/img33.png', style="max-width: 100%; position: relative; left: 50%;")
          .col-9.bg-color3.shadow
            .h4 Programación
            p El calendario de entrega de los mensajes a los diferentes públicos debe estar bien planteado y respetarse de forma estricta.
      .col-lg-9.mb-5
        .row.align-items-center
          .col-2
            img(src='@/assets/curso/img34.png', style="max-width: 100%; position: relative; left: 50%;")
          .col-9.bg-color3.shadow
            .h4 Recursos necesarios
            p Es necesario definir todos los recursos que se requieren para el desarrollo de una adecuada comunicación interna: técnicos, tecnológicos, humanos y económicos.
      .col-lg-9.mb-5
        .row.align-items-center
          .col-2
            img(src='@/assets/curso/img35.png', style="max-width: 100%; position: relative; left: 50%;")
          .col-9.bg-color3.shadow
            .h4 Medición
    ...
    TabsC
      .py-3.py-md-4(titulo="Intranet")
        .row.align-items-center
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/img36.png', style="max-width: 60%; margin: auto;")
      .py-3.py-md-4(titulo="Blogs")
        .row.align-items-center
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/img37.png', style="max-width: 60%; margin: auto;")
      .py-3.py-md-4(titulo="Mailing")
        .row.align-items-center
          .col-md-6.mb-4.mb-md-0
            .h4 Mailing
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/img38.png', style="max-width: 60%; margin: auto;")
      .py-3.py-md-4(titulo="Carteleras")
        .row.align-items-center
          .col-md-6.mb-4.mb-md-0
            .h4 Carteleras
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/img39.png', style="max-width: 60%; margin: auto;")
      .py-3.py-md-4(titulo="Revista interna")
        .row.align-items-center
          .col-md-6.mb-4.mb-md-0
            .h4 Revista interna
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/img40.png', style="max-width: 60%; margin: auto;")
      .py-3.py-md-4(titulo="Redes sociales corporativas")
        .row.align-items-center
          .col-md-6.mb-4.mb-md-0
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/img41.png', style="max-width: 60%; margin: auto;")
      .py-3.py-md-4(titulo="Reuniones informativas")
        .row.align-items-center
          .col-md-6.mb-4.mb-md-0
          ...
          .col-md-6
            figure
              img(src='@/assets/curso/img42.png', style="max-width: 60%; margin: auto;")
