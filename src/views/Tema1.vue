  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.align-items-center
      ...
      .col-lg-5.mt-4.mt-lg-0
        figure
          img(src='@/assets/curso/img1.png', style="max-width: 60%; margin: auto;")
    .row.my-5
      .col-12.shadow
        .bloque-texto-b
          .row.p-4.bg-color1.align-items-center
            .col-lg-4
              figure
                img(src='@/assets/curso/img2.png', style="max-width: 60%; margin: auto;")
    ...
    .row.mb-5.align-items-center
      ...
      .col-lg-4
        figure.mt-4.mt-lg-0
          img(src='@/assets/curso/img3.png', style="max-width: 60%; margin: auto;")
      .col-12
